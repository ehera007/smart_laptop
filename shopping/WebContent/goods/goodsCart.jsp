...
<head>
<meta charset="UTF-8">
<title>goodsCart</title>
<script type="text/javascript" src="http://code.jquery.com/jquery-latest.js"></script>
<script>
	function checkQty(prodNum, prodProce, cartQty){
		if(cartQty>1){
	...
	function prodChk(){
		...
		document.getElementById("totlaPrice").innerHTML=prodTot;
		document.getElementById("prodCnt").innerHTML=cnt;
	}
</script>
<body>
<p>장바구니 페이지입니다. <a href="main.sm">홈으로</a></p>
...
<table border = 1 width="600" align="center">
	<tr>
		<td colspan="4"><input type="checkbox" value="${dto.productDTO.prodNum }" name="prodCk" onchange="prodChk();" checked />
	...
	<tr><td><img src="goods/upload/${dto.productDTO.prodImage.split(',')[0] }" width="50"/></td>
		...
		<td align="center">
		<a href="javascript:checkQty('${dto.productDTO.prodNum }','${dto.productDTO.prodProce }','${dto.cartDTO.cartQty }')"> - </a>
		&nbsp;&nbsp; ${dto.cartDTO.cartQty} &nbsp;&nbsp; 
		<a href="goodsCartAdd.gd?prod=${dto.productDTO.prodNum }&qty=1&&prodPrice=${dto.productDTO.prodPrice }"> + </a> </td>
...
<tr><td colspan="8" align="center"><input type="submit" value="구매하기"/></td></tr>
</form>
</table>
</body>
</html>
